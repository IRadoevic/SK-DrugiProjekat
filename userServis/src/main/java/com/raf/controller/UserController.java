...
public class UserController {
    ...
    public ResponseEntity<UserDto> saveUser(@RequestBody @Valid UserCreateDto userCreateDto) {
        ...
        notificationRequest.setFirstName(userCreateDto.getFirstName());
        notificationRequest.setLastName(userCreateDto.getLastName());
        notificationRequest.setEmail(userCreateDto.getEmail());
        notificationRequest.setNotificationType("activation");
        jmsTemplate.convertAndSend(orderDestination, messageHelper.createTextMessage(notificationRequest));
    ...
    public ResponseEntity<UserDto> saveManager(@RequestBody @Valid ManagerCreateDto managerCreateDto) {
        ...
        NotificationRequestDto notificationRequest = new NotificationRequestDto();
        notificationRequest.setFirstName(managerCreateDto.getFirstName());
        notificationRequest.setLastName(managerCreateDto.getLastName());
        notificationRequest.setEmail(managerCreateDto.getEmail());
        notificationRequest.setNotificationType("activation");
